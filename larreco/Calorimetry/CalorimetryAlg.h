...
namespace calo {
  ...
  public:
    ...
    double
    dEdx_AMP(art::Ptr<recob::Hit> const& hit,
             double const pitch,
             double const T0 = 0) const
    {
      return dEdx_AMP(*hit, pitch, T0);
    }
    ...
    double
    dEdx_AREA(art::Ptr<recob::Hit> const& hit,
              double const pitch,
              double const T0 = 0) const
    {
      return dEdx_AREA(*hit, pitch, T0);
    }
