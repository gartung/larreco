	...
	double cosThr)
{
	...
	if (dist < d)
	{
		...
		Point3D_t endpoint1 = trk1->back()->Point3D();
		Point3D_t trk2front0 = trk2->Nodes()[0]->Point3D();
		Point3D_t trk2front1 = trk2->Nodes()[1]->Point3D();
		Point3D_t proj1 = pma::GetProjectionToSegment(endpoint1, trk2front0, trk2front1);
		double distProj1 = sqrt( pma::Dist2(endpoint1, proj1) );

		Point3D_t endpoint2 = trk2->front()->Point3D();
		Point3D_t trk1back0 = trk1->Nodes()[nodeEndIdx]->Point3D();
		Point3D_t trk1back1 = trk1->Nodes()[nodeEndIdx - 1]->Point3D();
		...
		double distProjThr)
{
	...
	Point3D_t proj1 = pma::GetProjectionToSegment(f1, f0, b0);
