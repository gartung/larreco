...
public:
  ...
  /// Returns true if the new position was accepted; returns false if the new
  /// position was trimmed to fit insite TPC volume + fMargin.
  ...
  {
    if (setAllNodes || !fIsVertex)
      fIsVertex = IsBranching();
  }
