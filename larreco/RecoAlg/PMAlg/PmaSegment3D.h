...
public:
  ...
  /// Get 3D projection of a 2D point from the view, no limitations if it falls
  /// beyond the segment endpoints.
  TVector3 GetUnconstrainedProj3D(const TVector2& p2d,
                                  unsigned int view) const override;
...
private:
  ...
  static double GetDist2(const TVector3& psrc,
                         const TVector3& p0,
                         const TVector3& p1);
  static double GetDist2(const TVector2& psrc,
                         const TVector2& p0,
                         const TVector2& p1);
};
