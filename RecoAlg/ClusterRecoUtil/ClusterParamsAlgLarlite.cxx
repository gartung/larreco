#ifndef CLUSTERPARAMSALGLARLITE_CXX
#define CLUSTERPARAMSALGLARLITE_CXX

#include "ClusterParamsAlgLarlite.h"
#include "Utilities/GeometryHelper.h"

namespace larlitecluster{

  void ClusterParamsAlg::FillParams(cluster::cluster_params & fParams){
    ...
    ::cluster::cluster_params localCopy;
    if (_debug)
      localCopy = fParams;
