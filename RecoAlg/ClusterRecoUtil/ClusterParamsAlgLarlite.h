...
/** \addtogroup ClusterRecoUtil
    ...
    @{*/
#ifndef CLUSTERPARAMSALGLARLITE_H
#define CLUSTERPARAMSALGLARLITE_H
...
namespace larlitecluster{
  ...
  public:
    ...
    void FillParams(cluster::cluster_params &);
  ...
  protected:
    ...
    std::vector<::larlitecluster::ParamsAlgBase * > _modules;
