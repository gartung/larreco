...
//----------------------------------------------------------------------------------------------
{
  ...
  std::vector<std::vector<Hit2D> > Hits;//(clusters.size(), std::vector<Hit2D>());
...
float CFAlgoChargeDistrib::TProfConvol(std::vector<Hit2D> hA , std::vector<Hit2D> hB)
{
  art::ServiceHandle<util::DetectorProperties> detProp;
  int NumTimeSamples = detProp->NumberTimeSamples()
