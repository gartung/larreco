...
CBAlgoShortestDistNonEndpoint::CBAlgoShortestDistNonEndpoint() {
...
bool CBAlgoShortestDistNonEndpoint::Bool(const ::cluster::cluster_params &cluster1,
    const ::cluster::cluster_params &cluster2)
{
  ...
  double w_end1   = cluster1.end_point.w;
  double t_end1   = cluster1.end_point.t;

  double w_start2 = cluster2.start_point.w;
  double t_start2 = cluster2.start_point.t;
  double w_end2   = cluster2.end_point.w;
  double t_end2   = cluster2.end_point.t;
...
double CBAlgoShortestDistNonEndpoint::ShortestDistanceSquared(double point_x, double point_y,
